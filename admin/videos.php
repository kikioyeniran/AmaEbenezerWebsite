...
if (isset($_POST['insert'])) {
    ...
    $link = $_POST['link'];
    $query = "INSERT INTO videos(title, description, link,picture) Values ('$title', '$description', '$link', '$image')";
    if ($mysqli->query($query) or die($mysqli->error)) {
        if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
            echo "<script>alert('Video Link Uploaded successfully')</script>";
        } else {
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <a href="edit.php?video=<?php echo urlencode($row['id']); ?>"><img src='images/<?php echo $row['picture'] ?>' alt="user" class="rounded" width="100%"></a>
                                </div>
                            </div>
